...
const layout = ({
  ...
  return (
    <div className="scrollbar-hidden container grid max-w-[1400px] grid-cols-[4fr_8fr] gap-x-[30px] gap-y-[35px] overflow-x-hidden px-[30px] pt-[110px] lg:grid-cols-1 sm:px-[16px] sm:pt-0">
